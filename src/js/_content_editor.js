...
var ContentEditor = {
  ...
  linkEditor: function (event) {
    var $target = $(event.target), // Current Link (target element)
      ...
      targetLinkText = $.trim($target.html()), // Current Link Text
    ...
    $.fancybox.open({
      ...
      opts: {
        ...
        afterShow: function (instance, current) {
          ...
          $(".modal-btn-cancel", modalContainer).on("click", () =>
            instance.close()
          );
  ...
  imageEditor: function (event) {
    ...
    var $target = $(event.target), // Current Image (target element)
      ...
      targetImageSrc = $target.attr("src"), // Current Image Src
      targetImageAlt = $target.attr("alt"), // Current Image Alt
      targetImageWidth = $target.width(), // Current Image Width
      targetImageHeight = $target.height(), // Current Image Height
      ...
      opts: {
        ...
        afterShow: function (instance, current) {
          ...
          $(".modal-btn-ok", modalContainer).on("click", function (event) {
            ...
            if (imageURL) {
              //Wrap image with link if URL is present
